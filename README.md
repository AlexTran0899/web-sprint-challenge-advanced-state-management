...
actions is the function, reducers modified the state and store combine both into one

3. What does `redux-thunk` allow us to do? How does it change our `action-creators`?

redux thunk allow us to wait for the data to get back before executing the function
